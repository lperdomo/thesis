...
/*
// Matlab interface 
// Input:theta, rho,thetaList', rhoList'
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	/* FILE *infile = fopen("pVoteCnt.txt","a"); */
	/* FILE *infile = fopen("vote.txt","a"); */
	/* normalize counts */
	for (i=0;i<numR*numT;i++) {
		/*int teste = pVoteCnt[i];*/
  		/* fprintf(infile, "%d;%d;\n", i, teste); */
		pVote[i] = (double)(pVoteCnt[i])/numData;
		/*double teste2 = pVote[i]; 
		fprintf(infile, "1;%d;%d;%f;\n", i, teste, teste2);*/
